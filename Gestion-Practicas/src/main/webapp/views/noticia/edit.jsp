...
<form:form id="formId" action="noticia/edit.do" modelAttribute="noticiaForm">
	...
	<fieldset>
		...
		<div class="form-group col-md-10">
			...
			<button id="save" name="save" type="submit" class="btn btn-dark"><spring:message code="noticia.submit" /></button>
			&nbsp;&nbsp;
			<button type="button" class="btn btn-dark" onclick="javascript: window.location.replace('noticia/list.do');">
