...
<fieldset>
	<form:form action="tutor/edit.do" modelAttribute="tutorForm">
		<form:hidden path="id" />
		...
		<jstl:if test="${tutorForm.id != 0}">
			<div class="row">
				<div class="form-group col-md-4">
					<gp:password id="password" code="actor.password" path="password" cssClass="form-control" />
				</div>
				<div class="form-group col-md-4">
